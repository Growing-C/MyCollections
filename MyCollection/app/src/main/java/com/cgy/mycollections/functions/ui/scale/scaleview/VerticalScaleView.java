...
public class VerticalScaleView extends View {
    ...
    private void init() {
        ...
        mTextColorInt = getResources().getColor(android.R.color.black);
        mLineColorInt = getResources().getColor(android.R.color.darker_gray);
        mNumberColorInt = getResources().getColor(android.R.color.white);
        mLineDarkColorInt = getResources().getColor(R.color.colorPrimaryDark);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画指针线
        paint.setColor(mLineDarkColorInt);
        ...
        //绘制当前刻度值数字
        paint.setColor(mNumberColorInt);
        float v = (float) (Math.round(currentValue * 10)) / 10;//保留一位小数

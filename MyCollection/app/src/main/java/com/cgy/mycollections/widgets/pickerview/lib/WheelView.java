package com.cgy.mycollections.widgets.pickerview.lib;
...
import com.cgy.mycollections.widgets.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    private static final float CENTERCONTENTOFFSET = 10;//中间文字文字居中需要此偏移值
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        customTextSize = true;//   此值为true pickerview_textsize才会有效果
        if (attrs != null) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //中间两条横线
        canvas.drawLine(0.0F, firstLineY - CENTERCONTENTOFFSET, measuredWidth, firstLineY - CENTERCONTENTOFFSET, paintIndicator);

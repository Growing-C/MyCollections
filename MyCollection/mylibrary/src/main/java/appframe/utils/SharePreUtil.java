...
public class SharePreUtil {
     ...
     * @param context
     */
    public static void clearPref(String preName, Context context) {
     ...
     * @param context
     * @param key     long的键值
     * @return 键值对应的long, 默认返回-1
     */
    public static long getLong(String preName, Context context, String key) {
        SharedPreferences pre = context.getSharedPreferences(preName, Context.MODE_PRIVATE);
        return pre.getLong(key, -1);
    }

    /**
     * 从配置文件读取Boolean值
     *
     * @return 如果没有，默认返回defaultValue
     */
    public static Boolean getBoolean(String preName, Context context, String key, boolean defaultValue) {
        SharedPreferences pre = context.getSharedPreferences(preName, Context.MODE_PRIVATE);

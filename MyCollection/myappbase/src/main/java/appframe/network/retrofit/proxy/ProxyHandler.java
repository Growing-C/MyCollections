...
//            String loginName = SharedPreferencesUtils.getInstance(MyApplication.getInstance()).getString(Constants.KEY_DOCTOR_LOGIN_NAME, "");
//            String loginPwd = SharedPreferencesUtils.getInstance(MyApplication.getInstance()).getString(Constants.KEY_DOCTOR_PASSWORD, "");
//            ApiWrapper.getInstance().syncLogin(loginName, loginPwd, "")
//                    .subscribe(new MyCallBack<DoctorBean>() {
//                        @Override
//                        public void onSuccess(DoctorBean model) {
